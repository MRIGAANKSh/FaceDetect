...
function FaceDetection() {
  ...
  return (
    <div className={`flex items-center justify-center h-screen bg-#beeefb transition-all duration-300 ${isWide ? 'w-[800px]' : 'w-[640px]'}`}>
      <div className={`relative bg-white p-6 rounded-lg shadow-lg text-center flex flex-col items-center justify-center ${isVideoVisible ? 'w-full h-full' : 'w-180 h-120'}`}>
        {!isVideoVisible && (
          <>
