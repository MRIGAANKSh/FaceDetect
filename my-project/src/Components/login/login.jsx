...
const Box1 = styled.div`
  ...
  @media (max-width: 768px) {
    transform: ${(props) =>
      props.clicked ? "translateX(80%)" : "translateX(5%)"};
  }

  @media (max-width: 480px) {
    width: 100%;
    transform: ${(props) => (props.clicked ? "translateY(90%)" : "translateY(10%)")};
  }
...
const Box2 = styled.div`
  ...
  @media (max-width: 480px) {
    width: 100%;
    transform: ${(props) => (props.clicked ? "translateY(-122%)" : "translateY(0)")};
  }
`;
...
const ButtonAnimate = styled.button`
  ...
  @media (max-width: 480px) {
    top: 85%;
    right: ${(props) => (props.clicked ? "45%" : "30%")};
  }
`;
